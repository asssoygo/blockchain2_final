...
Parameter MockAggregator.setAnswer(int256)._answer (src/oracle/MockAggregator.sol#49) is not in mixedCase
Parameter MockAggregator.setUpdatedAt(uint256)._updatedAt (src/oracle/MockAggregator.sol#58) is not in mixedCase
Parameter PriceOracle.setPriceFeed(address)._newFeed (src/oracle/PriceOracle.sol#112) is not in mixedCase
Parameter PriceOracle.setDefaultMaxAge(uint256)._newMaxAge (src/oracle/PriceOracle.sol#121) is not in mixedCase
Parameter AccessControlFixed.setCriticalParameter(uint256)._value (src/security/AccessControlFixed.sol#24) is not in mixedCase
Parameter AccessControlFixed.withdrawAll(address)._to (src/security/AccessControlFixed.sol#35) is not in mixedCase
Parameter AccessControlVulnerable.setCriticalParameter(uint256)._value (src/security/AccessControlVulnerable.sol#25) is not in mixedCase
Parameter AccessControlVulnerable.changeOwner(address)._newOwner (src/security/AccessControlVulnerable.sol#32) is not in mixedCase
Parameter AccessControlVulnerable.withdrawAll(address)._to (src/security/AccessControlVulnerable.sol#39) is not in mixedCase
Parameter GovernanceToken.setVestingContract(address)._vesting (src/token/GovernanceToken.sol#116) is not in mixedCase
Parameter TreasuryV1.initialize(address)._owner (src/treasury/TreasuryV1.sol#82) is not in mixedCase
Parameter TreasuryV2.initializeV2(uint256)._spendingWindowDuration (src/treasury/TreasuryV2.sol#68) is not in mixedCase
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#conformance-to-solidity-naming-conventions
INFO:Detectors:
Detector: too-many-digits
AMMFactory.predictPairAddress(address,address,bytes32) (src/amm/AMMFactory.sol#113-118) uses literals with too many digits:
	- initCode = abi.encodePacked(type()(AMM).creationCode,abi.encode(token0,token1)) (src/amm/AMMFactory.sol#115)
MathLib.sqrtYul(uint256) (src/libraries/MathLib.sol#24-80) uses literals with too many digits:
	- ! xAux_sqrtYul_asm_0 < 0x100000000000000000000000000000000 (src/libraries/MathLib.sol#36-39)
MathLib.sqrtYul(uint256) (src/libraries/MathLib.sol#24-80) uses literals with too many digits:
	- ! xAux_sqrtYul_asm_0 < 0x10000000000000000 (src/libraries/MathLib.sol#40-43)
MathLib.sqrtYul(uint256) (src/libraries/MathLib.sol#24-80) uses literals with too many digits:
	- ! xAux_sqrtYul_asm_0 < 0x100000000 (src/libraries/MathLib.sol#44-47)
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#too-many-digits
INFO:Detectors:
Detector: immutable-states
MockAggregator.decimals (src/oracle/MockAggregator.sol#21) should be immutable 
MockAggregator.version (src/oracle/MockAggregator.sol#27) should be immutable 
Reference: https://github.com/crytic/slither/wiki/Detector-Documentation#state-variables-that-could-be-declared-immutable
INFO:Slither:src analyzed (86 contracts with 101 detectors), 71 result(s) found
